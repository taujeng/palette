...
const InitialState = () => {
  ...
  // in Next.js, the app will render first server-side, where localStorage is not available
  // before then running client-side
  // if (typeof localStorage !== 'undefined') {
    const [startingData1, setStartingData1] = useState("") 
  ...
  // } else {
  //   // If localStorage is not available, handle it here
